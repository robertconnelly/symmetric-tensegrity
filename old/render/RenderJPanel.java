...
/**
   Provides a JPanel interface to the {@link Renderer}.<p>
...
public class RenderJPanel extends JPanel implements Runnable {
   ...
   */
   ...
   protected class MouseHandler extends MouseInputAdapter {
      RenderJPanel rp;
      public MouseHandler(RenderJPanel r) {
         rp = r;
      }
   ...
   protected class KeyHandler extends KeyAdapter {
      ...
      public KeyHandler(RenderJPanel r) {
         rp = r;
      }
